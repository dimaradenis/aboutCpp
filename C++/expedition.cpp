...
int main()
{
    ...
    do
    {
        ...
        gotoxy(3, 11);
        printf("2. Tampil Data Paket\n");
        gotoxy(3, 12);
        printf("3. Proses Paket ke Sorting\n");
        gotoxy(3, 13);
        printf("4. Menampilkan Sorting Paket\n");
        gotoxy(3, 14);
        printf("5. Proses ke Kurir\n");
        gotoxy(3, 15);
        printf("6. Paket yang Belum Terkirim\n");
        gotoxy(3, 16);
        printf("7. Mengirim Paket\n");
        gotoxy(3, 17);
        printf("8. Jumlah Barang Terkirim\n");
        gotoxy(3, 18);
...
void tambah_paket1(node1 **head)
{
    ...
    fflush(stdin);
    gotoxy(42, 13);
    printf("Kode Kota Tujuan [3 Digit]	 : ");
    scanf("%s", &kode_tujuan1);
    fflush(stdin);
    gotoxy(19, 19);
    printf("Masukkan Estimasi Hari             : ");
...
void tampilkan_paket3(queue myQueue)
{
    ...
    {
        gotoxy(27, 1);
        printf("PAKET YANG BELUM TERKIRIM\n");
        while (temp != NULL)
        {
